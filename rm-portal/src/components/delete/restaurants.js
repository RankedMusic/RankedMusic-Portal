...
//   only can delete if logged in as creator user
  const deleteReview = (reviewId, index) => {
    ...
    return (
        <div>
            {/* if there is a restaurant (otherwise return non selected - at bottom) */}
            {restaurant ? (
                <div>
                    ...
                    <h4> Reviews </h4>
                    <div className="row">
                        {/* if there are reviews (>0) -> otherwise returns no reviews */}
                        {restaurant.reviews.length > 0 ? (
                            // for each review -> going to be cards w text, user, date
                                ...
                                <div className="col-lg-4 pb-1" key={index}>
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            {/* if there is a user is logged in + is logged in as the creator of the review -> && if true = does it*/}
