...
//         let video_comments = await get_likes(single_video_url)
...
const get_comments = async (url) => {
    ...
    // let comments = await page.$x("/html/body/div[1]/section/main/div/div[1]/article/div[3]/section[2]/div/div/a/span");
    // // console.log(likes)
    // let comments_text = await page.evaluate(element => element.textContent, comments[0]);
    
    // let comments_num = parseFloat(comments_text.replace(/,/g, ''));
