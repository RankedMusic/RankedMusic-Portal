...
async function getViewsFromArray(influencers, client, links_array){
    ...
    for (let i = 0; i < links_array.length; i = i + 1){
        ...
        if(views_object != null){
            ...
            console.log('The video ' + single_video_url + ' has ' + views_object.views_num + ' views') 
...
const get_Num_Views = async (video_url, profile_url) => {
    ...
    // await page.waitForXPath('/html/body/div/div/div[2]/div[2]/div/main/div[2]/div[1]/div[3]/div[1]/div/div/a/span/div/div/div/div/div/strong');
